...
describe('Create tweet tests', () => {
  ...
  test('Should not create a Tweet and return an exception', async () => {
    const data = {
      content: 'Testing Tweet',
    }
    const spy = jest.spyOn(Tweet, 'create').mockImplementation(() => {
...
describe('get all the Tweets', () => {
  test('testing limit for get all', async () => {
    const data = {
      content: 'Testing tweet',
    }
    const tweetsArray = [{ ...data, createdAt: '2022-02-12', updatedAt: '2022-02-12' }, { ...data, createdAt: '2022-02-12' }];
